...
a1.25 <- ggplot(rawData[rawData$year == 40,], aes(x=scenario, y=meanSeed,color=scenario)) +
  geom_boxplot() +
...
ggsave(filename = paste("PlotProgress_finalPlots/Gain_boxplot_Seed.png"), plot = a1.25, width = 6, height = 5, scale = 1.1)
...
# PS vs. Seed-Ped    1.13 (95% CI [1.11, 1.15])
# PS vs. Seed-GSc    1.53 (95% CI [1.49, 1.56])
# PS vs. Seed-GSunc  1.57 (95% CI [1.53, 1.62])
# PS vs. ECT-GS      1.48 (95% CI [1.44, 1.52])
...
# Seed-Ped vs. Seed-GSc    1.35 (95% CI [1.33, 1.37])
# Seed-Ped vs. Seed-GSunc  1.39 (95% CI [1.36, 1.42])
