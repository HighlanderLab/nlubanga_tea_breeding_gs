...
nReps = 30
scenarios = c("PS", "PedigreeBlup","PedigreeBlup_Seed5", 
              "Seed_GSconst5", "Seed_GSconst_pheno5", "Seed_GSconst_noECT5", "Seed_GSconst_pheno_noECT5", "Seed_GSconst_6y5",
              "Seed_GSunconst5", "Seed_GSunconst_pheno5", "Seed_GSunconst_noECT5", "Seed_GSunconst_pheno_noECT5", "Seed_GSunconst_6y5",
              "ECT_GS5","ECT_GS_pheno5")
...
rawData$scenario <- factor(rawData$scenario, 
                           levels=c("PS", "Pedigree", "Pedigree-Seed",
                                    ...
                                    "Seed-GSunconst","Seed-GSunconst-pheno","Seed-GSunconst-noECT","Seed-GSunconst-6y",
                                    "ECT-GS-pheno","ECT-GS"))
